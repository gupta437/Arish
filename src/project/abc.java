...
public class abc {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		ArrayList<ArrayList<String>> precursorSteps =new ArrayList<ArrayList<String>>();
		 ...
		 System.out.println("input-- "+precursorSteps);
	  ...
	  System.out.println("hashtable-- "+dataset);
	  System.out.println("Final Result-- "+printResult2(dataset));
	  }
	    ...
	    Map<List<String>,String> reverseMap = new HashMap<List<String>,String>();
	      ...
	      for(Map.Entry<String,List<String>> entry : dataset.entrySet()){
	    		if(!reverseMap.containsKey(entry.getValue())) {
	    			...
	    			List<List<String>> result1= printResult2(dataset);
	    			List<List<String>> result3 = new ArrayList<List<String>>();
	    			int n = result1.size()-1;
	    			for(int k=n;k>-1;k--) {
	    				List<String> op5 = result1.get(k);
	    				result3.add(op5);
	    			}
	    			return result3;
	    		}
